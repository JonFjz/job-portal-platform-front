        ...
        <div v-if="companies.length" class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="my-4 text-center">
              <p class="company-name text-cyan-900 dark:text-gray-100 text-xl font-semibold">
                {{ company.companyName }}
              </p>
            </div>
            <div class="flex justify-center mt-6">
              <button class="px-4 py-2 text-cyan-900 dark:text-gray-100 border border-green-500 dark:border-green-600 font-semibold rounded hover:bg-green-500 hover:text-white dark:hover:bg-green-600 dark:hover:text-gray-100">
                See Jobs
              </button>
            </div>
          </div>
