        ...
        .filter((job) => {
            return (
                (!props.filters.keyword ||
                    job.title.toLowerCase().includes(props.filters.keyword.toLowerCase())) &&
                (!props.filters.workType ||
                    job.title.toLowerCase().includes(props.filters.workType.toLowerCase())) &&
                (!props.filters.level ||
                    job.title.toLowerCase().includes(props.filters.level.toLowerCase())) &&
...
<template>
    <div class="lg:col-span-5">
        <div class="bg-gray-100 rounded-2xl px-4 py-4 mb-4 dark:bg-gray-700 dark:text-gray-300">
            ...
            <p class="mt-2 text-gray-600 00 dark:text-gray-300">
