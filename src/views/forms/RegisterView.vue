...
const registerUser = async () => {
  try {
    ...
    const endpoint = role.value === 'jobseeker' ? 'register-as-a-jobSeeker' : 'register-as-a-employer';
    const response = await axios.post(`https://localhost:7136/api/Auth0/${endpoint}`, {
