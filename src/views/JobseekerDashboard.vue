    ...
    <div class="flex w-screen h-screen bg-white">
            ...
            <ul class="space-y-4">
                ...
                <li>
                    ...
                    >
                        ...
                        >
                            <path
                                d="M3 3a2 2 0 00-2 2v10a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2H3zM1 5a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H3a2 2 0 01-2-2V5zm2 6h12v2H3v-2zm0-4h12v2H3V7z"
                            ></path>
                        </svg>
        ...
        <main class="flex-1 p-6 bg-gray-100">
            ...
            <div v-if="currentView === 'bookmarks'" class="bg-white p-6 rounded-lg shadow-md">
                ...
                <div v-if="bookmarkedJobs.length === 0" class="text-gray-500">
